...
public class DistributedLockAspect {
	...
	@Pointcut("@annotation(top.zylsite.cheetah.base.common.redisson.DistributedLock)")
	public void distributedLockAspectPoint() {
	}

	@SuppressWarnings({ "rawtypes", "unchecked" })
	@Around(value = "distributedLockAspectPoint()")
	...
	@AfterThrowing(value = "distributedLockAspectPoint()", throwing = "ex")
	...
	public String getLockName(Method method, Object[] args) {
		...
		if (isNotEmpty(lockName)) {
			String preLockName = annotation.lockNamePre(), postLockName = annotation.lockNameSuffix(),
