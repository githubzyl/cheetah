...
public class MasterDataSourceConfiguration {
	...
	@Primary
	public PlatformTransactionManager setTransactionManager(
	...
	@Primary
	public SqlSessionFactory setSqlSessionFactory(@Qualifier("masterDataSource") DataSource masterDataSource)
			throws Exception {
		...
		factoryBean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources(MASTER_MAPPER_LOCATION));
		// 分页插件
	...
	public SqlSessionTemplate setSqlSessionTemplate(
			@Qualifier("masterSqlSessionFactory") SqlSessionFactory masterSqlSessionFactory) throws Exception {
