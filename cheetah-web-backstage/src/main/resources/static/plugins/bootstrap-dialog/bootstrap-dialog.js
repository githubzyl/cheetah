    ...
    BootstrapDialog.prototype = {
        ...
        createModalDialog: function () {
        	if(this.options.style){
        		return $('<div class="modal-dialog" style="'+this.options.style+'"></div>');
        	}
        ...
        createModalBody: function () {
        	if(this.options.modelBodyStyle){
        		return $('<div class="modal-body" style="'+this.options.modelBodyStyle+'"></div>');
        	}
